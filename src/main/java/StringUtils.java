...
public class StringUtils {
	/*private static Set<String> stopWords = new HashSet<String>(
			Arrays.asList("a", "about", "above", "after", "again", "against", "all", "am", "an", "and", "any", "are", "aren't", "as", "at", "be", 
					...
					"or", "other", "ought", "our", "ours", "ourselves", "out", "over", "own", "same", "shan't", "she", "she'd", "she'll", "she's", 
...
//		s = removeStemming(s);
	...
	// use Lucene to remove stop words
	private static String removeStopWords(String s) {
		s = s.toLowerCase();
		return stopWords.contains(s) ? "" : s;
	}
...
//	private static String removeStemming(String s) {
